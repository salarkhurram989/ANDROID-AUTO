...
public class MainActivity extends Activity {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onGeolocationPermissionsShowPrompt(
                ...
                if (origin.startsWith("https://salarkhurram989.github.io/")) {
                    requestLocationPermissionIfNeeded(callback, origin);
                } else {
    ...
    private void openSpotifyOrMusicApp() {
        // Prefer Spotify when it is installed and accepts its URI scheme.
        try {
            Intent spotify = new Intent(Intent.ACTION_VIEW, Uri.parse("spotify:"));
            startActivity(spotify);
            return;
        } catch (Exception ignored) {
            // Fall through to the Android standard music-app selector.
        }
